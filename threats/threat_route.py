...
from threats.FirmwareUpload import FirmwareUpload
from threats.attack_log import get_attack_logs, log_attack
from threats.attack_request import AttackRequest
from threats.ml_evasion_detector import SensorReading, model
from threats.replay_threat import ReplayRequest, is_fresh_timestamp, USED_NONCES
from threats.spoofing_threat import SpoofingRequest
import re
...
# @router.get("/trigger")
# async def trigger_attack(attack: str):
#     simulated_alert = {
#         "timestamp": datetime.utcnow().isoformat(),
#         "sensor_id": "sim_sensor_01",
#         "attack_type": attack,
#         "message": f"{attack.capitalize()} test triggered",
#         "severity": "High" if attack in ["ddos", "firmware"] else "Medium",
#         "blocked": True
#     }
#
#     await broadcast_alert(simulated_alert)
#     return {"status": f"{attack.capitalize()} alert sent"}
