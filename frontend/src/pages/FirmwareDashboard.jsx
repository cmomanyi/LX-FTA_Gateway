...
const FirmwareDashboard = () => {
    ...
    const sampleDownload = () => {
        const validFirmware = {
            name: "sample_device_firmware",
            version: "v1.0.0",
            features: ["secure boot", "data signing"],
            checksum: "abcd1234efgh5678"
        };

        const blob = new Blob([JSON.stringify(validFirmware, null, 2)], {
        ...
        a.href = url;
        a.download = "sample_firmware.json";
        a.click();
        ...
        <Layout>
            <div className="p-4 max-w-4xl mx-auto">
                ...
                <div className="mb-2 text-sm">
                    <button onClick={sampleDownload} className="text-blue-600 underline hover:text-blue-800">
                        ⬇️ Download Sample Firmware File
                    </button>
                </div>
                ...
                {uploadResult && (
                    <div className="bg-gray-100 p-4 rounded mb-4 border border-gray-300">
                        <h2 className="font-bold">Result:</h2>
                        <pre className="text-sm text-green-700">{JSON.stringify(uploadResult, null, 2)}</pre>
                    </div>
                )}
