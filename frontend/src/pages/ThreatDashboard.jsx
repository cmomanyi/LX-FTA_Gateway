...
const ATTACK_OPTIONS = [
    {
        label: "Spoofing",
        id: "spoofing",
        sensor_id: "unauthorized_99",
        description: "Unauthorized sensor mimicking a legitimate one",
    },
    {
        label: "Replay",
        id: "replay",
        sensor_id: "soil_01",
        description: "Old data with reused nonce to confuse systems",
    },
    {
        label: "Firmware Tampering",
        id: "firmware",
        sensor_id: "plant_02",
        description: "Modified sensor firmware sent without integrity check",
    },
    {
        label: "Overflow",
        id: "overflow",
        sensor_id: "water_01",
        description: "Excessively large or malformed metric values sent",
    },
];
...
const ThreatDashboard = () => {
    ...
    const simulateSensor = async () => {
        ...
        try {
            const res = await fetch("https://api.lx-gateway.tech/sensor/threat", {
                method: "POST",
